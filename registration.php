...
<div style="height:500px; width:550px; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
     <form method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >

    <tr><td colspan="2"  align="center">Donor Registration
...
<tr><td>&nbsp;</td><td><input type="submit" value="Register" name="sbmt"</td></tr></table>
</td></tr>
</table>
</form>
        </div>
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Design by Suranjit Ray |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
